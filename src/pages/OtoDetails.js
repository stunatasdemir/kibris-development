            ...
            <div className='details-content'>
                ...
                <div className='details-sidebar'>
                    ...
                    <div className='details-user'>
                        <h2>Ekleyen Kişinin Bilgileri</h2>
                        <ul>
                            <li><strong>Ad Soyad:</strong> {car.user && `${car.user.firstName} ${car.user.lastName}`}</li>
                            <li><strong>İletişim:</strong> {car.user && car.user.contactInfo}</li>
                            <li><strong>Üyelik Tarihi:</strong> {car.user && new Date(car.user.memberSince).toLocaleDateString()}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    {allCars.map((similarCar) => (
                        <Link key={similarCar._id} to={`/details/${similarCar._id}`} className='similar-car-item'>
                            ...
                            <div className='similar-car-info'>
                                ...
                                <p className="similar-car-price">{similarCar.price} £</p>
                            </div>
                        </Link>
                    ))}
                </div>
